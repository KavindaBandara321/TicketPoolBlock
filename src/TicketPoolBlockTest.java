...
public class TicketPoolBlockTest {
    @Test
    public void testAddAndPurchaseTicket() {
        TicketPoolBlock ticketPool = new TicketPoolBlock(1);
    ...
    public void testPoolSizeMinimumCorrection() {
        ...
        TicketPoolBlock ticketPool = new TicketPoolBlock(Math.max(inputPoolSize, 3));
        assertTrue(ticketPool != null, "TicketPool should be created with default minimum size.");
    }

    @Test
    public void testAddingMaxVendors() {
        TicketPoolBlock pool = new TicketPoolBlock(5);
        ...
        // Attempt to add 11th vendor should fail logically (in Menu it shows warning)
    }

    //Test Exit When All Threads Stopped
    @Test
    ...
    public void testMaxSizeZeroBehavior() throws InterruptedException {
        TicketPoolBlock pool = new TicketPoolBlock(0);
    ...
    public void testAddTicketWhenPoolIsFullBlocks() throws InterruptedException {
        TicketPoolBlock pool = new TicketPoolBlock(1);
    ...
    public void testPerformanceUnderLoad() throws InterruptedException {
        ...
        TicketPoolBlock ticketPool = new TicketPoolBlock(poolSize);
